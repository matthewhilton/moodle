    ...
    public static function upsert_override_provider(): array {
        return [
            ...
            'update override, but new data has no user or group set' => [
                ...
                'expectedrecordscreated' => 0,
                'expectedevent' => '',
                'expectedexception' => get_string('overridemustsetuserorgroup', 'quiz'),
            ],
            'saving both group and userid - expected invalid' => [
                ...
                'expectedrecordscreated' => 0,
                'expectedevent' => '',
                'expectedexception' => get_string('overridecannotsetbothgroupanduser', 'quiz'),
            ],
            ...
            'form data is empty' => [
                ...
                'expectedevent' => '',
                'expectedexception' => get_string('overridemustchangesetting', 'quiz'),
            ],
            ...
            'user id is invalid' => [
                ...
                'expectedrecordscreated' => 0,
                'expectedevent' => '',
                'expectedexception' => get_string('overrideinvaliduser', 'quiz'),
            ],
            'group id is invalid' => [
                'existingdata' => [],
                'formdata' => [
                ...
                'expectedrecordscreated' => 0,
                'expectedevent' => '',
                'expectedexception' => get_string('overrideinvalidgroup', 'quiz'),
            ],
            'timeclose is before timestart' => [
                ...
                'expectedrecordscreated' => 0,
                'expectedevent' => '',
                'expectedexception' => get_string('overridetimeclosebeforetimeopen', 'quiz'),
            ],
            ...
            'timelimit is negative' => [
                ...
                'expectedrecordscreated' => 0,
                'expectedevent' => '',
                'expectedexception' => get_string('overrideinvalidtimelimit', 'quiz'),
            ],
            'attempts is negative' => [
                ...
                'expectedrecordscreated' => 0,
                'expectedevent' => '',
                'expectedexception' => get_string('overrideinvalidattempts', 'quiz'),
            ],
            'existing id given is invalid' => [
                ...
                'expectedrecordscreated' => 0,
                'expectedevent' => '',
                'expectedexception' => get_string('overrideinvalidexistingid', 'quiz'),
            ],
            'user value changed when updated (not allowed)' => [
                ...
                'expectedrecordscreated' => 1,
                'expectedevent' => '',
                'expectedexception' => get_string('overridecannotchange', 'quiz'),
            ],
            ...
            'create multiple for the same user (not allowed)' => [
                ...
                'expectedrecordscreated' => 0,
                'expectedevent' => '',
                'expectedexception' => get_string('overridemultiplerecordsexist', 'quiz'),
            ],
