...
$string['overridetimeclosebeforetimeopen'] = 'Closing time cannot be before or equal to opening time';
...
$string['overridemustchangesetting'] = 'At least 1 setting must be changed';
$string['overridemultiplerecordsexist'] = 'Multiple overrides cannot be made for the same user/group';
$string['overrideinvalidattempts'] = 'Invalid attempts value';
$string['overrideinvalidtimelimit'] = 'Invalid time limit value';
$string['pageshort'] = 'P';
