...
class competency_override_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        $scale = $dg->create_scale(array("scale" => "not,partially,fully"));
    ...
    public function test_ruleoutcome_overridegrade() {
     ...
     */
    private function get_related_competencies(int $compid) {
