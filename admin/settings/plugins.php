...
/// Editor plugins
    ...
    // Status check.
    $temp->add(new admin_setting_heading('antivirus/statuschecks', new lang_string('statuschecks', 'antivirus'), ''));
    $temp->add(new admin_setting_check('antivirus/checkantivirus', (new \core\check\environment\antivirus())->get_ref()));
